package org.rsbot.script.internal.util;
 ...
 * @author Qauters
 */
public class Global extends File {

	private static final long serialVersionUID = 9081385558893463127L;

	public Global(final File parent, final String child) {
		super(parent, child
				+ (child.endsWith(".jar") ? "!" + File.separator : ""));
	}

	public Global(final String pathname) {
		super(pathname
				+ (pathname.endsWith(".jar") ? "!" + File.separator : ""));
	}

	public Global(final String parent, final String child) {
		super(parent, child
				+ (child.endsWith(".jar") ? "!" + File.separator : ""));
	}

	public Global(final URI uri) {
		super(uri.toString()
				+ (uri.toString().endsWith(".jar") ? "!" + File.separator : ""));
	}
	...
	public File getAbsoluteFile() {
		return new Global(getAbsolutePath());
	}

	@Override
	public File getCanonicalFile() throws IOException {
		return new Global(getCanonicalPath());
	}
	...
	public File[] listFiles(final FileFilter filter) {
		...
		for (final String s : ss) {
			final File f = new Global(this, s);
	...
	public URI toURI() {
		try {
			/* Generate the uri */
			String uri = (isJarEntry() ? "jar:" : "")
			+ super.toURI().toString();
