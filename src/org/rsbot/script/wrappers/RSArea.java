...
public class RSArea {
	...
	/**
	 * Determines, whether a given RSObject is located in the area
	 * 
	 * @param tile
	 *            The RSObject to check for
	 * @return true if it's located in the area
	 */
	public boolean contains(final RSObject obj) {
	...
	/**
	 * Determines, whether a given RSCharacter is located in the area
	 * 
	 * @param tile
	 *            The RSCharacter to check for
	 * @return true if it's located in the area
	 */
	public boolean contains(final RSCharacter ch) {
		RSTile loc = ch.getLocation();
	...
	private RSTile[][] createTileRectagle(final int x, final int y,
