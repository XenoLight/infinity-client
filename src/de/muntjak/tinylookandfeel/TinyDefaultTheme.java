...
public class TinyDefaultTheme extends DefaultMetalTheme {
	...
	public void addCustomEntriesToTable(final UIDefaults table) {
		...
		table.put("InternalFrame.normalTitleFont",
				Theme.internalFrameTitleFont.getFont());
		table.put("InternalFrame.paletteTitleFont",
				Theme.internalPaletteTitleFont.getFont());
		...
		table.put("CheckBoxMenuItem.foreground",
				Theme.menuItemFontColor.getColor());
		...
		table.put("Table.selectionForeground",
				Theme.tableSelectedForeColor.getColor());
		table.put("Table.selectionBackground",
				Theme.tableSelectedBackColor.getColor());
		...
		// New in 1.4.0
		table.put("Table.alternateRowColor",
				Theme.tableAlternateRowColor.getColor());
		...
		table.put("ProgressBar.selectionForeground",
				Theme.progressSelectForeColor.getColor());
		table.put("ProgressBar.selectionBackground",
				Theme.progressSelectBackColor.getColor());
		table.put("PopupMenu.background", Theme.menuPopupColor);

		// Note: TabbedPane.background is the default background color of
		// unselected tabs,
		...
		table.put("ComboBox.disabledBackground",
				Theme.textDisabledBgColor.getColor());
		...
		table.put("PasswordField.selectionBackground",
				Theme.textSelectedBgColor.getColor());
		table.put("PasswordField.selectionForeground",
				Theme.textSelectedTextColor.getColor());
		...
		table.put("ComboBox.selectionBackground",
				Theme.comboSelectedBgColor.getColor());
		table.put("ComboBox.selectionForeground",
				Theme.comboSelectedTextColor.getColor());
		table.put("ComboBox.focusBackground",
				Theme.comboSelectedBgColor.getColor());

		table.put("List.selectionForeground",
				Theme.listSelectedTextColor.getColor());
		table.put("List.selectionBackground",
				Theme.listSelectedBgColor.getColor());
		// new in 1.4.0
		...
		table.put("Tree.selectionBackground",
				Theme.treeSelectedBgColor.getColor());
		table.put("Tree.selectionForeground",
				Theme.treeSelectedTextColor.getColor());
		...
		table.put("TitledBorder.border",
				new LineBorder(Theme.titledBorderColor.getColor()));
