 ...
 * @author Sorcermus
 */
public class NPCIDFinderGUI extends JFrame {

	private static final long serialVersionUID = 4202832089460727935L;
	
	public static final Logger log = Logger.getLogger(NPCIDFinderGUI.class.getName());
    ...
    public NPCIDFinderGUI() {

    	setIconImage(new ImageIcon(GlobalConfiguration.Paths.getIconDirectory() + "/log.png").getImage());

        setTitle("NPC ID Search");
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(" NPC ID Lookup "));

        searchResults.setModel(new AbstractListModel() {
			private static final long serialVersionUID = 6678300804418097048L;
			String[] strings = {" "};
    ...
    private void termKeyTyped(KeyEvent evt) {
        File file = new File(GlobalConfiguration.Paths.getNPCIDCache());
        String search = null;
